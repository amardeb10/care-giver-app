...
export default function Activity() {
  ...
  return (
    <div className="App">
      <Alert show={show == 1} variant="success" onClose={() => setShow(1)}>Activity has been created sucessfully!</Alert>
      <Alert show={show == 2} variant="success" onClose={() => setShow(2)}>Activity has been deleted sucessfully!</Alert>  
      <div className="row">
                ...
                <tbody>
                  {data.map((val, key) => (
                    <tr key={key}>
                      ...
                      <td onClick={() => deleteActivity(val.id)} className='text-center'>
